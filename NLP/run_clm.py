...
def parse_args():
   ...
   parser.add_argument(
    ...
    parser.add_argument(
        "--name",
         type=str,
        default="very_cool_GPT_experiment"
    )
  ...
  ## path to saved model properties values
    parser.add_argument(
    ...
    #### Specify if we want to compute properties with respect to some stationary point
    parser.add_argument(
        "--check_opt",
        type=bool,
        default=False,
...
def main():
    ...
    if args.dataset_name is not None:
        ...
        data_files = []
        for i in range(10):
            data_files.append("/projectnb/aclab/datasets/pile/raw_data/train/0"+str(i)+".jsonl")
        for i in range(10,30):
            data_files.append("/projectnb/aclab/datasets/pile/raw_data/train/"+str(i)+".jsonl")
        raw_datasets_train = load_dataset('json', data_files = data_files,  cache_dir="/projectnb/aclab/tranhp/.cache", streaming = args.streaming)
        raw_datasets_val = load_dataset('json', data_files = ["/projectnb/aclab/datasets/pile/raw_data/val.jsonl"],  cache_dir="/projectnb/aclab/tranhp/.cache", streaming = args.streaming)
    ...
    train_dataloader = LoadIt(None, root_dir = '/projectnb/aclab/tranhp/trainDataloader_pile/', max_workers = 1)
